...
$sicUrlBase = defined('SIC_URL_BASE') ? SIC_URL_BASE : '/sicurezza'; // ← ADATTARE se la cartella ha nome diverso
?>
        ...
        <form onsubmit="sicAddAttestato(event)">
            <div class="sic-form-row">
                <div class="sic-form-group">
                    ...
                    <select name="att_nome" id="sic-sel-dipendente" required onchange="sicAutoFillSede(this)">
                        <option value="">— Seleziona dipendente —</option>
                    </select>
                </div>
                <div class="sic-form-group">
                    <label>Sede</label>
                    <select name="att_sede" id="sic-sel-sede" required>
                        <option value="">— Seleziona sede —</option>
                    </select>
                </div>
                <div class="sic-form-group">
                    <label>Corso / Attestato</label>
                    <select name="att_corso" id="sic-sel-corso" required>
