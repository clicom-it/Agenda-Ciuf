...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Catalogo corsi con mapping agli ID della piattaforma esterna';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Configurazione modificabile dall admin';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Log operazioni automatiche del modulo sicurezza';
