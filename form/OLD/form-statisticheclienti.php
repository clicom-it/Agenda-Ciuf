...
<div class="graficostatistiche sizing">
    <form method="post" action="" id="statisticheannoclienti" name="statisticheannoclienti">
        <input type="text" name="anno" id="anno" value=""  class="required input_moduli sizing float_moduli_small" placeholder="Anno per statistiche" title="Anno per statistiche" /> 
        ...
        <div style="float: left; padding-left: 20px; padding-top: 10px; height: 15px;"><a href="javascript:;" onclick="javascript:stampaselezionestatclienti();"><i class="fa fa-print fa-lg" aria-hidden="true"></i> stampa selezione</a></div>
...
<div class="graficostatistiche sizing">
    <form method="post" action="" id="statisticheannoclienti2" name="statisticheannoclienti2">
        <input type="text" name="anno2" id="anno2" value=""  class="required input_moduli sizing float_moduli" placeholder="Anno per statistiche (confronto)" title="Anno per statistiche (confronto)" />
        ...
        <input type="submit" class="submit_form submit_form_10 nopost" value="Invia" id="submitstatisticheannoclienti2" />
        <div style="float: left; padding-left: 20px; padding-top: 10px; height: 15px;"><a href="javascript:;" onclick="javascript:stampaselezionestatclienti2();"><i class="fa fa-print fa-lg" aria-hidden="true"></i> stampa selezione</a></div>
        <div class="chiudi" style="height: 20px;"></div>
    </form>
    <div class="chiudi"></div>
