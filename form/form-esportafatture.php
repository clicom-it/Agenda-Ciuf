...
<form method="post" action="" id="stampefatture" name="stampefatture">
    ...
    Tipo Fatture: <input type="checkbox" id="vendita" name="vendita" checked> Vendita <input type="checkbox" id="nota" name="nota"> Nota di credito <input type="checkbox" id="proforma" name="proforma"> Proforma <input type="checkbox" id="acquisto" name="acquisto"> Acquisto <input type="checkbox" id="pa" name="pa"> Pubblica Amministrazione
    <div class="chiudi"></div>
    Stato fatture: <input type="checkbox" id="pagata" name="pagata"> Pagata <input type="checkbox" id="nonpagata" name="nonpagata"> Non pagata
    <div class="chiudi"></div>
    Metodo pagamento: <input type="checkbox" id="day" name="day"> Tutti i metodi di pagamento bonifico 120gg fine mese
