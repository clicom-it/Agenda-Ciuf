...
<form method="post" action="" id="formutenti" name="formutenti">
    ...
    <input type="text" name="nome" id="nome" class="input_moduli sizing  float_moduli" placeholder="Nome" title="Nome" />            
    <input type="text" name="cognome" id="cognome" class="input_moduli sizing  float_moduli" placeholder="Cognome" title="Cognome" />       
    <div class="chiudi"></div>
