...
$nomeelencoatelier_sede = '';
foreach ($atelier as $atelierd) {
    $nomeelencoatelier .= "<option value=\"" . $atelierd['id'] . "\">" . $atelierd['nominativo'] . "</option>";
    $nomeelencoatelier_sede .= "<option value=\"" . $atelierd['id'] . "\">" . $atelierd['nominativo'] . "</option>";
}
...
<form method="post" action="" id="formdipendenti" name="formdipendenti">    
    ...
    <!--        <input type="text" name="username" id="username" class="input_moduli sizing float_moduli" placeholder="Username" title="Username" autocomplete="off" />-->
        ...
        <select name="sesso" id="sesso" class="input_moduli float_moduli_small">
        ...
        <select name="idatelier_sede" id="idatelier_sede" class="extra input_moduli float_moduli_small">
            <option value="0">Sede di assunzione</option>
            <?php echo $nomeelencoatelier_sede; ?>
        </select>
    <?php } else { //atelier ?>
        <div class="tit_big">LOGIN</div>
        <input type="text" name="email" id="email" class="input_moduli sizing float_moduli" placeholder="Email" title="Email" /> 
    ...
    <?php if ($_SESSION["livello"] == 0 || $_SESSION["livello"] == 1) { ?>
        ...
        <input type="checkbox" id="village" name="village" value="1" /> &Egrave; un Village Outlet
    <?php } ?>
    ...
    <?php if (($livello == 3 || $cols['livello'] == 3) && ($_SESSION["livello"] == 0 || $_SESSION["livello"] == 1)) { ?>
        ...
        <div class="tit_big">RETRIBUZIONE ATTUALE</div>
        <input type="date" name="data_inizio" id="data_inizio" class="input_moduli sizing float_moduli float_moduli_small_25" placeholder="Data inizio" title="Data inizio" />
        <input type="date" name="data_fine" id="data_fine" class="input_moduli sizing float_moduli float_moduli_small_25" placeholder="Data fine" title="Data fine" />
        ...
        <div class="chiudi"></div>
        <div class="tit_big">STORICO RETRIBUZIONE</div>
        <?php for ($i = 1; $i <= 5; $i++) { ?>
            ...
            <input type="text" name="ore_settimana_r[]" class="input_moduli sizing float_moduli float_moduli_small_25" placeholder="Ore settimana" title="Ore settimana" />
            <div class="chiudi"></div>
        <?php } ?>
    <?php } ?>
    <div class="chiudi"></div>
