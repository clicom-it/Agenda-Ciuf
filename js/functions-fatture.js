            ...
            success: function (msg) {
                ...
                for (var i = 0; i < msg['voci'].length; i++) {
                    ...
                    $('.contienirighe').append('<div class="rigaadd riga_prodotto_fatt sizing">\n\
                                            ...
                                            <input type="text" name="nome[]" class="input_moduli sizing float_moduli_small_10 nomepz" placeholder="Cerca (codice o titolo)" title="Cerca (codice o titolo)" value="' + msg['voci'][i].nome + '" />\n\
                                            ...
                                            <input type="text" name="importo[]" class="importo input_moduli sizing float_moduli_small_10" placeholder="Importo" title="Importo" value="' + msg['voci'][i].importo + '" />\n\
                                            ...
                                            <select name="iva[]" iva="iva' + i + '" class="iva input_moduli sizing float_moduli_small_5" placeholder="Iva" title="Iva">' + msg.ivaselect + ' </select>\n\
                                            ...
                                            <input type="hidden" name="idddt[]" class="input_moduli sizing float_moduli_small_10" value="' + msg['voci'][i].idddt + '" />\n\
                                            <input type="hidden" name="codice_iva[]" class="input_moduli sizing float_moduli_small_10" value="' + msg['voci'][i].codice_iva + '" />\n\
                                            <input type="hidden" name="idordine[]" class="input_moduli sizing float_moduli_small_10" value="' + msg['voci'][i].idordine + '" />\n\
...
//            var vocipreffatt = "";
            for (var i = 0; i < msg['voci'].length; i++) {
                ...
                var codiceiva = "";
                if (msg['voci'][i].codice_iva) {
                    codiceiva = msg['voci'][i].codice_iva;
                }

                $('.contienirighe').append('<div class="rigaadd riga_prodotto_fatt sizing rigaprevcomm_' + idprev + '">\n\
                                            <i class="fa fa-arrows-v fa-lg ordinarighe" aria-hidden="true"></i>\n\
                                            <select profitprev="profit' + i + '" name="idprofit[]" class="input_moduli sizing float_moduli_small_10" placeholder="Profit Center" title="Profit Center"><option value="0">Seleziona profit center</option>' + msg.vociprofit + '</select>\n\
                                            <input type="text" name="nome[]" class="input_moduli sizing float_moduli_small_10 nomepz" placeholder="Cerca (codice o titolo)" title="Cerca (codice o titolo)" value="' + msg['voci'][i].nome + '" />\n\
                                            <textarea name="descrizione[]" class="nosortable textarea_moduli_small sizing float_moduli_40" placeholder="Descrizione" title="Descrizione">Rif. prev. ' + msg['valori'][0]['numero'] + '.' + data[0] + ': ' + msg['voci'][i].descr + '</textarea>\n\
                                            <input type="text" name="um[]" class="input_moduli sizing float_moduli_small_10" placeholder="U.M." title="U.M." />\n\
                                            <input type="text" name="qta[]" class="qta input_moduli sizing float_moduli_small_5" placeholder="Q.ta" title="Q.ta" value="' + msg['voci'][i].qta + '" />\n\
                                            <input type="text" name="importo[]" class="importo input_moduli sizing float_moduli_small_10" placeholder="Importo" title="Importo" value="' + msg['voci'][i].prezzo + '" />\n\
                                            <input type="text" name="sconto[]" class="sconto input_moduli sizing float_moduli_small_10" placeholder="Sconto" title="Sconto" value="' + msg['voci'][i].sconto + '" />\n\
                                            <select name="iva[]"class="iva input_moduli sizing float_moduli_small_5" placeholder="Iva" title="Iva">' + msg.ivaselect + ' </select>\n\
                                            ...
                                            <input type="hidden" name="codice_iva[]" class="input_moduli sizing float_moduli_small_10" value="' + codiceiva + '" />\n\
...
/* ddt collegati */
function collegaDDT(id) {
    $.ajax({
        type: "POST",
        url: "./fatture.php",
        data: "id=" + id + "&submit=collegaddt",
        dataType: "json",
        success: function (msg) {
            $('.ddt' + msg['valori'][0]['id']).hide();
            /* id ddt collegato */
            var idddt = msg['valori'][0]['id'];
            /* data leggibile */
            var data = msg['valori'][0]['data'].split('-');
            /**/
            /* quale totale ddt */
            ...
            var vociddt = "";
            for (var i = 0; i < msg['voci'].length; i++) {
                vociddt += "<div class=\"nomevoceprev sizing\">" + msg['voci'][i].nome + "</div>\n\
                             <div class=\"descvoceprev sizing\">" + msg['voci'][i].descr + "</div>\n\
                             <div class=\"qtavoceprev sizing\">" + msg['voci'][i].qta + "</div>\n\
                             <div class=\"prezzovoceprev sizing\">" + msg['voci'][i].scontato + "</div>\n\
                             <div class=\"chiudi\"></div>";
                ...
                $('.contienirighe').append('<div class="rigaadd riga_prodotto_fatt sizing rigaddt_' + idddt + '">\n\
                                            <i class="fa fa-arrows-v fa-lg ordinarighe" aria-hidden="true"></i>\n\
                                            <select name="idprofit[]" class="input_moduli sizing float_moduli_small_10" placeholder="Profit Center" title="Profit Center"><option value="0">Seleziona profit center</option>' + msg.vociprofit + '</select>\n\
                                            <input type="text" name="nome[]" class="input_moduli sizing float_moduli_small_10 nomepz" placeholder="Cerca (codice o titolo)" title="Cerca (codice o titolo)" value="' + msg['voci'][i].nome + '" />\n\
                                            <textarea name="descrizione[]" class="nosortable textarea_moduli_small sizing float_moduli_40" placeholder="Descrizione" title="Descrizione">Rif. DDT. ' + msg['valori'][0]['numero'] + '.' + data[0] + ': ' + msg['voci'][i].descr + '</textarea>\n\
                                            <input type="text" name="um[]" class="input_moduli sizing float_moduli_small_10" placeholder="U.M." title="U.M." />\n\
                                            <input type="text" name="qta[]" class="qta input_moduli sizing float_moduli_small_5" placeholder="Q.ta" title="Q.ta" value="' + msg['voci'][i].qta + '" />\n\
                                            <input type="text" name="importo[]" class="importo input_moduli sizing float_moduli_small_10" placeholder="Importo" title="Importo" value="' + msg['voci'][i].prezzo + '" />\n\
                                            <input type="text" name="sconto[]" class="sconto input_moduli sizing float_moduli_small_10" placeholder="Sconto" title="Sconto" value="' + msg['voci'][i].sconto + '" />\n\
                                            ...
                                            <input type="hidden" name="idfatt[]" class="input_moduli sizing float_moduli_small_10" value="0" />\n\
                                            <input type="hidden" name="idddt[]" class="input_moduli sizing float_moduli_small_10" value="' + idddt + '" />\n\
                                            <input type="hidden" name="codice_iva[]" class="input_moduli sizing float_moduli_small_10" value="' + codiceiva + '" />\n\
                                            <input type="hidden" name="idordine[]" class="input_moduli sizing float_moduli_small_10" value="0" />\n\
                                            <input type="hidden" name="idcomm[]" class="input_moduli sizing float_moduli_small_10" value="0" />\n\
                                            <input type="hidden" name="idvocecomm[]" class="input_moduli sizing float_moduli_small_10" value="0" />\n\
            ...
            /**/
            var htmlddt = "<div class=\"rigaprevcomm sizing rigaddt_" + idddt + "\" >\n\
                            <input type=\"hidden\" name=\"idprevfatt[]\" value=\"" + idddt + "\" />\n\
                            <div class=\"numpreventivo sizing\">DDT. N° " + msg['valori'][0]['numero'] + "</div>\n\
                            <div class=\"datapreventivo sizing\">" + data[2] + "/" + data[1] + "/" + data[0] + "</div>\n\
                            <div class=\"titolopreventivo sizing\">&nbsp;</div>\n\
                            <div class=\"totalepreventivo sizing\">&nbsp;</div>\n\
                            <div class=\"eliminapreventivo sizing\">\n\
                            <a href=\"javascript:;\" onclick=\"javascript:$('.vociprev_" + idddt + "').slideToggle();\"><i class=\"fa fa-info-circle fa-lg\" aria-hidden=\"true\" style=\"color: #000000;\"></i></a> \n\
                            <a href=\"javascript:;\" onclick=\"delddt('" + idddt + "');\"><i class=\"fa fa-times fa-lg\" aria-hidden=\"true\"></i></a>\n\
                            </div>\n\
                            <div class=\"chiudi\"></div>\n\
                            <div class=\"vociprev_" + idddt + "\" style=\"display: none;\">\n\
                            " + vociddt + "\n\
                            </div>\n\
                            <div class=\"chiudi\"></div>\n\
                            </div>";
...
/* ordini collegati */
function collegaOrdine(id) {
    $.ajax({
        type: "POST",
        url: "./fatture.php",
        data: "id=" + id + "&submit=collegaordine",
        dataType: "json",
        success: function (msg) {
            $('.ord' + msg['valori'][0]['id']).hide();
            /* id ordine collegato */
            var idordine = msg['valori'][0]['id'];
            /* data leggibile */
            var data = msg['valori'][0]['data'].split('-');
            /**/
            /* quale totale ordine */
...
//                var totaleprint = "";
            ...
            var vociordine = "";
            for (var i = 0; i < msg['voci'].length; i++) {
                vociordine += "<div class=\"nomevoceprev sizing\">" + msg['voci'][i].nome + "</div>\n\
                             <div class=\"descvoceprev sizing\">" + msg['voci'][i].descr + "</div>\n\
                             <div class=\"qtavoceprev sizing\">" + msg['voci'][i].qta + "</div>\n\
                             <div class=\"prezzovoceprev sizing\">" + msg['voci'][i].scontato + "</div>\n\
                             <div class=\"chiudi\"></div>";
                ...
                $('.contienirighe').append('<div class="rigaadd riga_prodotto_fatt sizing rigaordine_' + idordine + '">\n\
                                            <i class="fa fa-arrows-v fa-lg ordinarighe" aria-hidden="true"></i>\n\
                                            <select name="idprofit[]" class="input_moduli sizing float_moduli_small_10" placeholder="Profit Center" title="Profit Center"><option value="0">Seleziona profit center</option>' + msg.vociprofit + '</select>\n\
                                            <input type="text" name="nome[]" class="input_moduli sizing float_moduli_small_10 nomepz" placeholder="Cerca (codice o titolo)" title="Cerca (codice o titolo)" value="' + msg['voci'][i].nome + '" />\n\
                                            <textarea name="descrizione[]" class="nosortable textarea_moduli_small sizing float_moduli_40" placeholder="Descrizione" title="Descrizione">Rif. ORDINE ' + msg['valori'][0]['numero'] + '.' + data[0] + ': ' + msg['voci'][i].descr + '</textarea>\n\
                                            <input type="text" name="um[]" class="input_moduli sizing float_moduli_small_10" placeholder="U.M." title="U.M." />\n\
                                            <input type="text" name="qta[]" class="qta input_moduli sizing float_moduli_small_5" placeholder="Q.ta" title="Q.ta" value="' + msg['voci'][i].qta + '" />\n\
                                            <input type="text" name="importo[]" class="importo input_moduli sizing float_moduli_small_10" placeholder="Importo" title="Importo" value="' + msg['voci'][i].prezzo + '" />\n\
                                            <input type="text" name="sconto[]" class="sconto input_moduli sizing float_moduli_small_10" placeholder="Sconto" title="Sconto" value="' + msg['voci'][i].sconto + '" />\n\
                                            ...
                                            <input type="hidden" name="idddt[]" class="input_moduli sizing float_moduli_small_10" value="0" />\n\
                                            <input type="hidden" name="codice_iva[]" class="input_moduli sizing float_moduli_small_10" value="' + codiceiva + '" />\n\
                                            <input type="hidden" name="idordine[]" class="input_moduli sizing float_moduli_small_10" value="' + idordine + '" />\n\
                                            <input type="hidden" name="idcomm[]" class="input_moduli sizing float_moduli_small_10" value="0" />\n\
                                            <input type="hidden" name="idvocecomm[]" class="input_moduli sizing float_moduli_small_10" value="0" />\n\
                                            <a href="javascript:;" class="remove_button"><i style="color: #CD0A0A; line-height: 35px;" class="fa fa-times fa-lg" aria-hidden="true"></i></a>\n\
                                            <div class="chiudi"></div>\n\
            ...
            if (msg['valori'][0]['appuntamento'] > 0) {
                $('.contienirighe').append('<div class="rigaadd riga_prodotto_fatt sizing rigaordine_' + idordine + '">\n\
                                            <i class="fa fa-arrows-v fa-lg ordinarighe" aria-hidden="true"></i>\n\
                                            <select name="idprofit[]" class="input_moduli sizing float_moduli_small_10" placeholder="Profit Center" title="Profit Center"><option value="0">Seleziona profit center</option>' + msg.vociprofit + '</select>\n\
                                            <input type="text" name="nome[]" class="input_moduli sizing float_moduli_small_10 nomepz" placeholder="Cerca (codice o titolo)" title="Cerca (codice o titolo)" value="" />\n\
                                            <textarea name="descrizione[]" class="nosortable textarea_moduli_small sizing float_moduli_40" placeholder="Descrizione" title="Descrizione">Rif. ORDINE ' + msg['valori'][0]['numero'] + '.' + data[0] + ':  Consegna su appuntamento</textarea>\n\
                                            <input type="text" name="um[]" class="input_moduli sizing float_moduli_small_10" placeholder="U.M." title="U.M." />\n\
                                            <input type="text" name="qta[]" class="qta input_moduli sizing float_moduli_small_5" placeholder="Q.ta" title="Q.ta" value="1" />\n\
                                            <input type="text" name="importo[]" class="importo input_moduli sizing float_moduli_small_10" placeholder="Importo" title="Importo" value="' + Math.round10(msg['valori'][0]['appuntamento'] / 1.22, -2) + '" />\n\
                                            <input type="text" name="sconto[]" class="sconto input_moduli sizing float_moduli_small_10" placeholder="Sconto" title="Sconto" value="" />\n\
                                            <select name="iva[]"class="iva input_moduli sizing float_moduli_small_5" placeholder="Iva" title="Iva">' + msg.ivaselect + ' </select>\n\
                                            <input type="hidden" name="totalevoce[]" class="totalevoce input_moduli sizing float_moduli_small_10 nopost" value="' + Math.round10(msg['valori'][0]['appuntamento'] / 1.22, -2) + '" />\n\
                                            <input type="hidden" name="totalevoceiva[]" class="totalevoceiva input_moduli sizing float_moduli_small_10 nopost" value="' + msg['valori'][0]['appuntamento'] + '" />\n\
                                            <input type="hidden" name="idprev[]" class="input_moduli sizing float_moduli_small_10" value="0" />\n\
                                            <input type="hidden" name="idfatt[]" class="input_moduli sizing float_moduli_small_10" value="0" />\n\
                                            <input type="hidden" name="idddt[]" class="input_moduli sizing float_moduli_small_10" value="0" />\n\
                                            <input type="hidden" name="idordine[]" class="input_moduli sizing float_moduli_small_10" value="' + idordine + '" />\n\
            ...
            /* spedizione */
            if (msg['valori'][0]['spedizione'] > 0) {
                $('.contienirighe').append('<div class="rigaadd riga_prodotto_fatt sizing rigaordine_' + idordine + '">\n\
                                            <i class="fa fa-arrows-v fa-lg ordinarighe" aria-hidden="true"></i>\n\
                                            <select name="idprofit[]" class="input_moduli sizing float_moduli_small_10" placeholder="Profit Center" title="Profit Center"><option value="0">Seleziona profit center</option>' + msg.vociprofit + '</select>\n\
                                            <input type="text" name="nome[]" class="input_moduli sizing float_moduli_small_10 nomepz" placeholder="Cerca (codice o titolo)" title="Cerca (codice o titolo)" value="" />\n\
                                            <textarea name="descrizione[]" class="nosortable textarea_moduli_small sizing float_moduli_40" placeholder="Descrizione" title="Descrizione">Rif. ORDINE ' + msg['valori'][0]['numero'] + '.' + data[0] + ':  Spese di spedizione</textarea>\n\
                                            <input type="text" name="um[]" class="input_moduli sizing float_moduli_small_10" placeholder="U.M." title="U.M." />\n\
                                            <input type="text" name="qta[]" class="qta input_moduli sizing float_moduli_small_5" placeholder="Q.ta" title="Q.ta" value="1" />\n\
                                            <input type="text" name="importo[]" class="importo input_moduli sizing float_moduli_small_10" placeholder="Importo" title="Importo" value="' + Math.round10(msg['valori'][0]['spedizione'] / 1.22, -2) + '" />\n\
                                            <input type="text" name="sconto[]" class="sconto input_moduli sizing float_moduli_small_10" placeholder="Sconto" title="Sconto" value="" />\n\
                                            <select name="iva[]"class="iva input_moduli sizing float_moduli_small_5" placeholder="Iva" title="Iva">' + msg.ivaselect + ' </select>\n\
                                            <input type="hidden" name="totalevoce[]" class="totalevoce input_moduli sizing float_moduli_small_10 nopost" value="' + Math.round10(msg['valori'][0]['spedizione'] / 1.22, -2) + '" />\n\
                                            <input type="hidden" name="totalevoceiva[]" class="totalevoceiva input_moduli sizing float_moduli_small_10 nopost" value="' + msg['valori'][0]['spedizione'] + '" />\n\
                                            <input type="hidden" name="idprev[]" class="input_moduli sizing float_moduli_small_10" value="0" />\n\
                                            <input type="hidden" name="idfatt[]" class="input_moduli sizing float_moduli_small_10" value="0" />\n\
                                            <input type="hidden" name="idddt[]" class="input_moduli sizing float_moduli_small_10" value="0" />\n\
                                            <input type="hidden" name="idordine[]" class="input_moduli sizing float_moduli_small_10" value="' + idordine + '" />\n\
            ...
            if (msg['valori'][0]['commissione_pagamento'] > 0) {
                $('.contienirighe').append('<div class="rigaadd riga_prodotto_fatt sizing rigaordine_' + idordine + '">\n\
                                            <i class="fa fa-arrows-v fa-lg ordinarighe" aria-hidden="true"></i>\n\
                                            <select name="idprofit[]" class="input_moduli sizing float_moduli_small_10" placeholder="Profit Center" title="Profit Center"><option value="0">Seleziona profit center</option>' + msg.vociprofit + '</select>\n\
                                            <input type="text" name="nome[]" class="input_moduli sizing float_moduli_small_10 nomepz" placeholder="Cerca (codice o titolo)" title="Cerca (codice o titolo)" value="" />\n\
                                            <textarea name="descrizione[]" class="nosortable textarea_moduli_small sizing float_moduli_40" placeholder="Descrizione" title="Descrizione">Rif. ORDINE ' + msg['valori'][0]['numero'] + '.' + data[0] + ':  Commissione su metodo di pagamento</textarea>\n\
                                            <input type="text" name="um[]" class="input_moduli sizing float_moduli_small_10" placeholder="U.M." title="U.M." />\n\
                                            <input type="text" name="qta[]" class="qta input_moduli sizing float_moduli_small_5" placeholder="Q.ta" title="Q.ta" value="1" />\n\
                                            <input type="text" name="importo[]" class="importo input_moduli sizing float_moduli_small_10" placeholder="Importo" title="Importo" value="' + Math.round10(msg['valori'][0]['commissione_pagamento'] / 1.22, -2) + '" />\n\
                                            <input type="text" name="sconto[]" class="sconto input_moduli sizing float_moduli_small_10" placeholder="Sconto" title="Sconto" value="" />\n\
                                            <select name="iva[]"class="iva input_moduli sizing float_moduli_small_5" placeholder="Iva" title="Iva">' + msg.ivaselect + ' </select>\n\
                                            <input type="hidden" name="totalevoce[]" class="totalevoce input_moduli sizing float_moduli_small_10 nopost" value="' + Math.round10(msg['valori'][0]['commissione_pagamento'] / 1.22, -2) + '" />\n\
                                            <input type="hidden" name="totalevoceiva[]" class="totalevoceiva input_moduli sizing float_moduli_small_10 nopost" value="' + msg['valori'][0]['commissione_pagamento'] + '" />\n\
                                            <input type="hidden" name="idprev[]" class="input_moduli sizing float_moduli_small_10" value="0" />\n\
                                            <input type="hidden" name="idfatt[]" class="input_moduli sizing float_moduli_small_10" value="0" />\n\
                                            <input type="hidden" name="idddt[]" class="input_moduli sizing float_moduli_small_10" value="0" />\n\
                                            <input type="hidden" name="idordine[]" class="input_moduli sizing float_moduli_small_10" value="' + idordine + '" />\n\
            ...
            /* buono sconto */
            if (msg['valori'][0]['buono'] > 0) {
                $('.contienirighe').append('<div class="rigaadd riga_prodotto_fatt sizing rigaordine_' + idordine + '">\n\
                                            <i class="fa fa-arrows-v fa-lg ordinarighe" aria-hidden="true"></i>\n\
                                            <select name="idprofit[]" class="input_moduli sizing float_moduli_small_10" placeholder="Profit Center" title="Profit Center"><option value="0">Seleziona profit center</option>' + msg.vociprofit + '</select>\n\
                                            <input type="text" name="nome[]" class="input_moduli sizing float_moduli_small_10 nomepz" placeholder="Cerca (codice o titolo)" title="Cerca (codice o titolo)" value="" />\n\
                                            <textarea name="descrizione[]" class="nosortable textarea_moduli_small sizing float_moduli_40" placeholder="Descrizione" title="Descrizione">Rif. ORDINE ' + msg['valori'][0]['numero'] + '.' + data[0] + ':  Buono sconto codice: ' + msg['valori'][0]['codice_buono'] + '</textarea>\n\
                                            <input type="text" name="um[]" class="input_moduli sizing float_moduli_small_10" placeholder="U.M." title="U.M." />\n\
                                            <input type="text" name="qta[]" class="qta input_moduli sizing float_moduli_small_5" placeholder="Q.ta" title="Q.ta" value="1" />\n\
                                            <input type="text" name="importo[]" class="importo input_moduli sizing float_moduli_small_10" placeholder="Importo" title="Importo" value="-' + Math.round10(msg['valori'][0]['buono'] / 1.22, -2) + '" />\n\
                                            <input type="text" name="sconto[]" class="sconto input_moduli sizing float_moduli_small_10" placeholder="Sconto" title="Sconto" value="" />\n\
                                            <select name="iva[]"class="iva input_moduli sizing float_moduli_small_5" placeholder="Iva" title="Iva">' + msg.ivaselect + ' </select>\n\
                                            <input type="hidden" name="totalevoce[]" class="totalevoce input_moduli sizing float_moduli_small_10 nopost" value="-' + Math.round10(msg['valori'][0]['buono'] / 1.22, -2) + '" />\n\
                                            <input type="hidden" name="totalevoceiva[]" class="totalevoceiva input_moduli sizing float_moduli_small_10 nopost" value="-' + msg['valori'][0]['buono'] + '" />\n\
                                            <input type="hidden" name="idprev[]" class="input_moduli sizing float_moduli_small_10" value="0" />\n\
                                            <input type="hidden" name="idfatt[]" class="input_moduli sizing float_moduli_small_10" value="0" />\n\
                                            <input type="hidden" name="idddt[]" class="input_moduli sizing float_moduli_small_10" value="0" />\n\
                                            <input type="hidden" name="idordine[]" class="input_moduli sizing float_moduli_small_10" value="' + idordine + '" />\n\
            ...
            /**/
            var htmlddt = "<div class=\"rigaprevcomm sizing rigaordine_" + idordine + "\" >\n\
                            <input type=\"hidden\" name=\"idprevfatt[]\" value=\"" + idordine + "\" />\n\
                            <div class=\"numpreventivo sizing\">Ordine N° " + msg['valori'][0]['numero'] + "</div>\n\
                            <div class=\"datapreventivo sizing\">" + data[2] + "/" + data[1] + "/" + data[0] + "</div>\n\
                            <div class=\"titolopreventivo sizing\">&nbsp;</div>\n\
                            <div class=\"totalepreventivo sizing\">&nbsp;</div>\n\
                            <div class=\"eliminapreventivo sizing\">\n\
                            <a href=\"javascript:;\" onclick=\"javascript:$('.vociprev_" + idordine + "').slideToggle();\"><i class=\"fa fa-info-circle fa-lg\" aria-hidden=\"true\" style=\"color: #000000;\"></i></a> \n\
                            <a href=\"javascript:;\" onclick=\"delOrdine('" + idordine + "');\"><i class=\"fa fa-times fa-lg\" aria-hidden=\"true\"></i></a>\n\
                            </div>\n\
                            <div class=\"chiudi\"></div>\n\
                            <div class=\"vociprev_" + idordine + "\" style=\"display: none;\">\n\
                            " + vociordine + "\n\
                            </div>\n\
                            <div class=\"chiudi\"></div>\n\
                            </div>";
            ...
            $('.noordinicoll').hide();
            $('.ordinicollegati').append(htmlddt);
            totalefattura();
...
//                var datarinnovoend = dataarr[2] + "/" + dataarr[1] + "/" + parseInt(year + 1);
                ...
                $('.contienirighe').append('<div class="rigaadd riga_prodotto_fatt sizing rigadom_' + iddom + '">\n\
                                            ...
                                            <input type="text" name="qta[]" class="qta input_moduli sizing float_moduli_small_5" placeholder="Q.ta" title="Q.ta" value="1" />\n\
                                            <input type="text" name="importo[]" class="importo input_moduli sizing float_moduli_small_10" placeholder="Importo" title="Importo" value="' + msg['valori'][0]['prezzo'] + '" />\n\
...
function delOrdine(id) {
    if (confirm("Stai per eliminare il contenuto, vuoi continuare?")) {
        $('.rigaordine_' + id).remove();
        $('.ord' + id).show();
        totalefattura();
    }
}
                ...
                for (var i = 0; i < msg['voci'].length; i++) {
                    ...
                    if (msg['voci'][i].statovoce > 0) {
                        ...
                        $('.contienirighe').append('<div class="rigaadd riga_prodotto_fatt sizing rigacomm_' + idcomm + '">\n\
                                            ...
                                            <select profit="profit' + i + '" name="idprofit[]" class="input_moduli sizing float_moduli_small_10" placeholder="Profit Center" title="Profit Center"><option value="0">Seleziona profit center</option>' + msg.vociprofit + '</select>\n\
                                            <input type="text" name="nome[]" class="input_moduli sizing float_moduli_small_10 nomepz" placeholder="Cerca (codice o titolo)" title="Cerca (codice o titolo)" value="' + msg['voci'][i].nome + '" />\n\
                                            <textarea name="descrizione[]" class="nosortable textarea_moduli_small sizing float_moduli_40" placeholder="Descrizione" title="Descrizione">' + msg['voci'][i].descr + '</textarea>\n\
                                            <input type="text" name="um[]" class="input_moduli sizing float_moduli_small_10" placeholder="U.M." title="U.M." />\n\
                                            <input type="text" name="qta[]" class="qta input_moduli sizing float_moduli_small_5" placeholder="Q.ta" title="Q.ta" value="1" />\n\
                                            <input type="text" name="importo[]" class="importo input_moduli sizing float_moduli_small_10" placeholder="Importo" title="Importo" value="' + msg['voci'][i].prezzocliente + '" />\n\
                                            <input type="text" name="sconto[]" class="sconto input_moduli sizing float_moduli_small_10" placeholder="Sconto" title="Sconto" value="" />\n\
                                            <select name="iva[]"class="iva input_moduli sizing float_moduli_small_5" placeholder="Iva" title="Iva">' + msg.ivaselect + ' </select>\n\
...
//            var vocipreffatt = "";
                for (var i = 0; i < msg['voci'].length; i++) {
                    ...
                    $('.contienirighe').append('<div class="rigaadd riga_prodotto_fatt sizing rigafatt_' + idfatt + '">\n\
                                            <i class="fa fa-arrows-v fa-lg ordinarighe" aria-hidden="true"></i>\n\
                                            <select profitfatt="profit' + i + '" name="idprofit[]" class="input_moduli sizing float_moduli_small_10" placeholder="Profit Center" title="Profit Center"><option value="0">Seleziona profit center</option>' + msg.vociprofit + '</select>\n\
                                            <input type="text" name="nome[]" class="input_moduli sizing float_moduli_small_10 nomepz" placeholder="Cerca (codice o titolo)" title="Cerca (codice o titolo)" value="' + msg['voci'][i].nome + '" />\n\
                                            <textarea name="descrizione[]" class="nosortable textarea_moduli_small sizing float_moduli_40" placeholder="Descrizione" title="Descrizione">' + msg['voci'][i].descrizione + '</textarea>\n\
                                            <input type="text" name="um[]" class="input_moduli sizing float_moduli_small_10" placeholder="U.M." title="U.M." value="' + msg['voci'][i].um + '" />\n\
                                            <input type="text" name="qta[]" class="qta input_moduli sizing float_moduli_small_5" placeholder="Q.ta" title="Q.ta" value="' + msg['voci'][i].qta + '" />\n\
                    ...
                    $("[iva=iva" + i + "]").val(msg['voci'][i].iva);
                    $("[profitfatt=profit" + i + "]").val(msg['voci'][i].idprofit);
