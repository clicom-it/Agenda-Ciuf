...
qq.FileUploaderBasic = function(o){
    ...
    this._options = {
        ...
        // messages
        messages: {
            typeError: "{file} ha una estensione non valida. Estensioni valide: {extensions}.",
            sizeError: "{file} troppo grande, massima dimensione: {sizeLimit}.",
            minSizeError: "{file} troppo piccolo, minima dimensione: {minSizeLimit}.",
            emptyError: "{file} vuoto, per favore seleziona un altro file.",
            noFilesError: "Nessun file da caricare.",
            onLeave: "I files sono stati caricati."
        },
...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        listElement: null,
        dragText: 'Trascina qui i file per caricarli',
        extraDropzones : [],
        hideDropzones : true,
        disableDefaultDropzone: false,
        uploadButtonText: 'Upload a file',
        cancelButtonText: '<i class="fa fa-times fa-lg" aria-hidden="true"></i> Cancella',
        ...
        fileTemplate: '<li>' +
            ...
            '<span class="qq-upload-file" style="float: left;"></span>' +
            '<span class="qq-upload-size"></span>' +
            '<a class="qq-upload-cancel" href="#" style="float: right; color: #000000; font-size: 0.9em;">{cancelButtonText}</a>' +
