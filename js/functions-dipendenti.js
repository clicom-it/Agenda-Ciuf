...
//                                && (!filter.nomeatelier.toLowerCase() || client.nomeatelier.toLowerCase().indexOf(filter.nomeatelier.toLowerCase()) > -1)
                ...
                var campi = [
                    ...
                    //{name: "cellulare", type: "text", title: "<b>Cellulare</b>", css: "customRow"},
                    {name: "nomeatelier", type: "text", title: "<b>Sede assunzione</b>", css: "customRow"},
                    {name: "attivo", type: "select", items: [
                            {name: "Seleziona", Id: ""},
                            {name: "Disattivo", Id: "0"},
                            {name: "Attivo", Id: "1"}
                ...
                if ($('#livello').val() === '5') {
                    ...
                    if ($('#livello').val() === '3') {
                        if (msg['valori'][0]['retribuzione'].length > 0) {
                            ...
                            $('#data_inizio').val(msg['valori'][0]['retribuzione'][0]['data_inizio']);
                            $('#data_fine').val(msg['valori'][0]['retribuzione'][0]['data_fine']);
                            ...
                            for (var i = 0; i < msg['valori'][0]['retribuzione'][0]['dati_retribuzione'].length; i++) {
                                ...
                                var ore_settimana_r = $('input[name="ore_settimana_r[]"]').get(i);
                                $(ore_settimana_r).val(msg['valori'][0]['retribuzione'][0]['dati_retribuzione'][i]['ore_settimana_r']);
                            }
                        }
                    }
                }
