...
define('SIC_DB_NAME',    'agecome_db2');      // Nome del database
define('SIC_DB_USER',    'agecome_usr');           // Utente MySQL
define('SIC_DB_PASS',    '!gQrOlkEoQ34bu8#');               // Password MySQL
...
define('GESTIONALE_API_URL', 'https://agenda.comeinunafavola.it/ws/services/dipendentiSicurezza');
define('GESTIONALE_API_URL_SANDBOX', 'http://agenda.comeinunafavola/ws/services/dipendentiSicurezza');
...
define('PIATTAFORMA_GET_ID',     'id');     // nome parametro GET per id
...
define('PIATTAFORMA_GET_CODFIS','cod_fis');
