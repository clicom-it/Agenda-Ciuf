...
) ENGINE=MyIsam DEFAULT CHARSET=utf8mb4 COMMENT='Anagrafica negozi/atelier';
...
CREATE TABLE IF NOT EXISTS `sic_dipendenti` (
    ...
    INDEX (`cognome_nome`)
) ENGINE=MyIsam DEFAULT CHARSET=utf8mb4 COMMENT='Dipendenti attivi, sincronizzati dal gestionale';
...
) ENGINE=MyIsam DEFAULT CHARSET=utf8mb4 COMMENT='Regole di copertura attestati per inquadramento';
...
CREATE TABLE IF NOT EXISTS `sic_regole_eccezioni` (
    ...
    INDEX (`nome_negozio`)
) ENGINE=MyIsam DEFAULT CHARSET=utf8mb4 COMMENT='Eccezioni per negozi specifici alle regole standard';
...
) ENGINE=MyIsam DEFAULT CHARSET=utf8mb4 COMMENT='Attestati formativi dei dipendenti';
...
) ENGINE=MyIsam DEFAULT CHARSET=utf8mb4 COMMENT='Validità in anni per ogni tipologia di corso';
