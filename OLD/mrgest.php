...
//        $clienti = getDati("clienti_fornitori", "");
    ...
    case "infoevento":
        ...
        if ($mostra_comandi) {
            $comandiextra = "<a href=\"javascript:;\" onclick=\"javascript:goup();aggiornalavoro('$id')\" style=\"position: absolute; right: 200px; bottom: 0px; color: #696969;\"><i class=\"fa fa-edit fa-2x\"></i> Modifica appuntamento</a>"
                    . "<a href=\"javascript:;\" onclick=\"javascript:editstep2('$id', 0, {$atelier[0]['solo_sartoria']}, $isSartoria)\" style=\"position: absolute; right: 10px; bottom: 0px; color: #696969;\"><i class=\"fa fa-edit fa-3x\"></i> Entra nella scheda</a>";
        } else {
            $comandiextra = "";
        }
