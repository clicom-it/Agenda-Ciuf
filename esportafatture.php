...
foreach ($fattura as $fatturad) {
    ...
    <thead>
                ...
                <th style=\"text-align: left; width: 58%; font-size: 8pt; border-bottom: 1px solid #ffffff; border-right: 1px solid #ffffff; padding:5px;\"><b>Descrizione</b></th>
        ...
        foreach ($voci as $vocid) {
            ...
            if ($qta == 0) {
                $vociprint .= "<tr>
            <td valign=top style=\"text-align: left; width: 58%; font-size: 8pt; padding:5px; border-right: 1px solid #cccccc;\"><i><strong>$nomevoce</strong></i></td>
            ...
            <td valign=top style=\"text-align: left; width: 10%; font-size: 8pt; padding:5px; border-right: 1px solid #cccccc;\">&nbsp;</td>
                ...
                $vociprint .= "<tr>
            <td valign=top style=\"text-align: left; width: 58%; font-size: 8pt; padding:5px; border-right: 1px solid #cccccc;\"><strong>$nomevoce</strong><br />" . join("<br />", $descrizionearr) . "</td>
...
//
    ...
    $html2pdf->Output('./tmp/' . $dir . '/fattura_' . $numero . '_' . $datafatt . '_' . pulisciImmagine($firma) . '.pdf', 'F');
}
...
foreach (glob("tmp/$dir/*.pdf") as $file) {
